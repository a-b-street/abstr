...
By combining all of the elements above, the `abstr` package provides a tidy dataframe, which can be further transformed to match [A/B Street's schema](https://a-b-street.github.io/docs/tech/dev/formats/scenarios.html)
...
For a more comprehensive guide in the art of collecting, transforming and saving data for A/B Street, check out the numerous `abstr` [vignette's](https://a-b-street.github.io/abstr/).
