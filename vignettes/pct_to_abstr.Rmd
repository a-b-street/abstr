...
```{r}
table(pct_regions_lookup$lad16nm[pct_regions_lookup$region_name == region_name])
```
...
exeter_commute_od = get_pct_lines(region = region_name, geography = "msoa") %>% # get commute od data
  filter(lad_name1 == lad_name &
