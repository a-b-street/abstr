...
Note: you may want to save the file to a different location, e.g. to the directory where you have cloned the `a-b-street/abstreet` repo (see below for more on this and change `~/orgs/a-b-street/abstreet` to the location where the repo is saved on your computer):

```{r, eval=FALSE}
ab_save(od_json1, f = "~/orgs/a-b-street/abstreet/scenario1.json")
```
...
./import.sh --city=gb/leeds --map north
...
git clone git@github.com:a-b-street/abstreet
cd abstreet # or wherever you cloned the A/B Street repo
./import.sh --city=br/sao_paulo --raw center
./import.sh --city=br/sao_paulo --map center
